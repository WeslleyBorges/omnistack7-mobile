    ...
    handleSelectImage = () => {
        ImagePicker.showImagePicker({
            ...
            if (upload.error)
                ...
                console.log('CANSELOU SAPOHA, MAN')
            else {
                const preview = {
                ...
                this.setState({ ...this.state, preview, image})
            }
        ...
        return (
            <View style={styles.container}>
                ...
                <TextInput
                    ...
                    onChangeText={place => this.setState({ ...this.state, place})} />
                ...
                <TextInput
                    ...
                    onChangeText={hashtags => this.setState({ ...this.state, hashtags})} />
